...
// 2) Calibrated for AUS 1997Q2
alpha   = 0.32249142203928585;
rhoa    = 0.04385933618177784;
sigma_a = 0.5867329623217815;
...
save('openness_DITR_AUS_1997Q2.mat', 'oo_', 'M_', 'options_');
